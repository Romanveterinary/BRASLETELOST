...
# Оновлені дозволи: Bluetooth, Локація, Батарея, Сховище, Вібрація та Wi-Fi
android.permissions = BLUETOOTH, BLUETOOTH_ADMIN, BLUETOOTH_SCAN, BLUETOOTH_CONNECT, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION, ACCESS_BACKGROUND_LOCATION, WAKE_LOCK, FOREGROUND_SERVICE, REQUEST_IGNORE_BATTERY_OPTIMIZATIONS, READ_EXTERNAL_STORAGE, READ_MEDIA_AUDIO, VIBRATE, ACCESS_WIFI_STATE, ACCESS_NETWORK_STATE
